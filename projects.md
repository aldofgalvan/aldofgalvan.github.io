...
demonstration collection for downstream robot learning. My contributions are the bilateral teleoperation system between the Lambda.7 haptic feedback device and Roboligent Optimo and PLATO arm-hand assembly enabling real-time, low-latency control.
